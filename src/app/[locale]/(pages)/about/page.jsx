              ...
              <div className="welcome-wrap text-center">
                ...
                >
                  <p>
                    ...
                    sharing driving tips and tricks, we're here to fuel your
                    love for everything on wheels.Feel free to ask any questions
                    you have, seek advice, or simply engage in friendly
        ...
        <div className="container">
          ...
          <div className="row mb-50 g-4 justify-content-center">
            ...
            >
              <div className="choose-card">
                ...
                <p>
                  Some may offer a full refund with no questions asked, others
                  may require the customer to provide...
                </p>
              </div>
            </div>
            <div
          ...
          <div className="our-activetis">
            <div className="row justify-content-center g-lg-4 gy-5">
              <div
                className="col-lg-3 col-sm-4 col-sm-6 divider d-flex justify-content-lg-start justify-content-sm-center wow fadeInUp"
                data-wow-delay="200ms"
              >
              ...
              <div
                className="col-lg-3 col-sm-4 col-sm-6 divider d-flex justify-content-sm-center wow fadeInUp"
                data-wow-delay="300ms"
              >
                <div className="single-activiti">
                  <div className="icon">
              ...
              <div
                className="col-lg-3 col-sm-4 col-sm-6 d-flex justify-content-lg-end justify-content-sm-center wow fadeInUp"
      ...
      <div className="drivco-gallery mb-100">
        <div className="container">
          ...
          <div className="row g-4 mb-50">
            ...
            <div
              className="col-lg-4 col-sm-6 d-flex align-items-end wow fadeInUp"
              data-wow-delay="300ms"
              data-wow-duration="1500ms"
            >
              <div className="gallery-item">
            ...
            <div
              className="col-lg-4 col-sm-6 d-flex align-items-start wow fadeInUp"
